...
// English dictionary for Plzeň — added 2026-08-28. Mirrors every other city's dictionary shape
...
export const plzenEn: CityTranslations = {
  ...
  home: {
    title: "Plzeň City Assembly",
    description:
      "Attendance, rebelliousness, and coalition alignment for Plzeň City Assembly members, derived from the assembly's roll-call votes (2022–2026 term).",
  ...
  seo: {
    siteTitle: "Plzeň City Assembly - mesta.datatimes.cz",
    titleSuffix: " — Plzeň — mesta.datatimes.cz",
    defaultDescription:
      "Roll-call vote analysis for the Plzeň City Assembly — attendance, rebelliousness, coalition alignment, and voting-position map.",
  },
  footer: {
    dataSource: "Data: usneseni.plzen.eu (assembly roll-call vote protocols), 2022–2026 term",
    aboutSection: "About",
