...
// English dictionary for Ústí nad Labem — added 2026-08-29. Mirrors every other city's dictionary
...
export const ustiNadLabemEn: CityTranslations = {
  ...
  home: {
    title: "Ústí nad Labem City Assembly",
    description:
      "Attendance, rebelliousness, and coalition alignment for Ústí nad Labem City Assembly members, derived from the assembly's roll-call votes (2022–2026 term).",
  ...
  seo: {
    siteTitle: "Ústí nad Labem City Assembly - mesta.datatimes.cz",
    titleSuffix: " — Ústí nad Labem — mesta.datatimes.cz",
    defaultDescription:
      "Roll-call vote analysis for the Ústí nad Labem City Assembly — attendance, rebelliousness, coalition alignment, and voting-position map.",
  },
  footer: {
    dataSource: "Data: usti.cz (assembly roll-call vote protocols), 2022–2026 term",
    aboutSection: "About",
