...
// English dictionary for Ostrava — added 2026-08-27. Mirrors praha.en.ts/brno.en.ts's shape and
// tone exactly; only city-specific facts differ. Same terminology rule as Praha/Brno applies (see
// praha.en.ts's comment): never "councillor" in English UI copy — use "assembly member".
export const ostravaEn: CityTranslations = {
  ...
  home: {
    title: "Ostrava City Assembly",
    description:
      "Attendance, rebelliousness, and coalition alignment for Ostrava City Assembly members, derived from the assembly's roll-call votes (2022–2026 term).",
  ...
  seo: {
    siteTitle: "Ostrava City Assembly - mesta.datatimes.cz",
    titleSuffix: " — Ostrava — mesta.datatimes.cz",
    defaultDescription:
      "Roll-call vote analysis for the Ostrava City Assembly — attendance, rebelliousness, coalition alignment, and voting-position map.",
  },
  footer: {
    dataSource: "Data: ostrava.cz (assembly roll-call vote pages), 2022–2026 term",
    aboutSection: "About",
